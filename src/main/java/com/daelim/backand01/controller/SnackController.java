...
public class SnackController {
    ...
    public String createSnack(@RequestBody CreateSnackReqDto dto) {
        return snackService.createSnack(dto);
    }
    ...
    public String updateSnack(@PathVariable Long id, @RequestBody UpdateSnackReqDto dto) {
        return snackService.updateSnack(id, dto);
    }
}